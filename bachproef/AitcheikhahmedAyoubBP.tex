...
\lstset{
    ...
    frame=single,                       
    language=Python,                    % Set the programming language (optional)
...
\usepackage{acronym}
\usepackage[nonumberlist,acronym,toc]{glossaries} % Include the glossaries package
\makeglossaries
...
\newacronym{mer}{MER}{Match Error Rate}
\newacronym{wil}{WIL}{Word Information Error}
\newacronym{wip}{WIP}{Word Information Preserved}
\newacronym{jwd}{JWD}{Jaro Winkler Dinstance}
...
\supervisor{Mevr. A. Bekkens}
\cosupervisor{Dhr. El. Baazizi}
\title[Ontwikkeling van een Proof-of-Concept Applicatie]%
    {Secondary Babytalkmonitor:\\Vergelijken van verschillende \\Speech-to-text modellen}
    %Ontwikkeling van een Proof-of-Concept Applicatie voor Spraak-naar-tekst Transcriptie van Vlaamse Een op-een Gesprekken in de Zorgsector.
...
\glsaddall
\printglossary[type=\acronymtype,title=Afkortingenlijst]
\input{voorwoord}
\input{samenvatting}
